...
<style>
* {
  --main-bg-color: #BFD4D9;;
  --jumbotron-bg-color: #638CA6;
  --main-body-font-color: black;
  --main-form-bg-color: #ffffff;
}
body {
...
<div class="container">
  ...
  <form class="form-horizontal" action="conf.php" method="post">
...
<br>
  ...
  <div class="form-group">
    <div class="col-sm-offset-2 col-sm-10">
      <button type="submit" class="btn btn-default" class="sub_but">Submit</button>
    </div>
  </div>
